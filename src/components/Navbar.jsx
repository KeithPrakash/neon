 ...
 isOpen &&  !isServiceOpen ?(
  ...
  <>
    ...
    <ul className={` flex flex-col justify-start items-start gap-[px] bg-white  w-full  text-base  ` }>
      ...
      <div className=' flex justify-between p-4 font-light text-xl hover:bg-primaryCol w-full hover:text-white'>
 ...
 <div>Medium</div>
   ...
   { isServiceOpen?(
    ...
    <ul className={` flex flex-col justify-start items-start gap-[px] bg-white  w-full  text-base  ` }>
      ...
      <div className='flex justify-start p-4 gap-4  font-light text-xl hover:bg-primaryCol w-full hover:text-white' onClick={()=>setServices(false)}>
